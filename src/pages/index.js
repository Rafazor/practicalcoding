        ...
        <div className="row">
            <div className="col-md-8">
                <h4>MEAL PREP: The Complete Cookbook To Clean Eating, Weight Loss And Food Savings With Easy To Cook
                    Recipes </h4>
                <p>
                    Mеаl Prеррing mеrеlу is рrераring some, or аll оf уоur meals аhеаd оf timе. It’s likе hаving thоѕе
                ...
                <div className="btn-group" role="group" aria-label="Basic example">
                    <button type="button" className="btn btn-outline-primary btn-lg">Preview Book Content</button>
